...
path = '/home/xinwang/';
dataName = 'caltech101_nTrain20_48'; %%%flower17; caltech101_10base; flower102; CCV; caltech101_numofbasekernel_10; bbcsport2view
%% %% caltech101_nTrain10_48
...
for iter =1:maxIter
    ...
    for ie =1:len
        load([path,'nTrain20/',dataName,'_missingRatio_',num2str(epsionset(ie)),'_norm_',num2str(qnorm),...
            '_clustering_iter_',num2str(iter),'.mat'],'res','alignment');
        res_acc_10(ie,:) =  res(1,:);
        res_nmi_10(ie,:) =  res(2,:);
        res_pur_10(ie,:) =  res(3,:);
        res_alg_10(ie,:) =  alignment;
    end
