...
dataName = 'ORL'; %%%caltech101_10base; flower17; flower102; psortPos; CCV;
...
for ie =1:length(epsionset)
    for iter = 1:30
        ...
        save([path,'work2016\myAbsentMKCres_random\',dataName,'_missingRatio_',num2str(epsionset(ie)),'_norm_',num2str(qnorm),...
            '_clustering_iter_',num2str(iter),'.mat'],'res','gamma1','gamma2','gamma3','gamma4','gamma5','gamma6','obj6');
    end
end