function S = generateMissingIndex(path,dataName,num,numker,Y,class_ratio)
...
%             end
    ...
    save(['D:\myWork\xinwangwork\AbsentMKL\MKLbenchmarkdatasets\',dataName,'_missingRatio_',...
        num2str(class_ratio),'_missingIndex_iter_',num2str(iter),'.mat'],'missingMatrix','S');
end